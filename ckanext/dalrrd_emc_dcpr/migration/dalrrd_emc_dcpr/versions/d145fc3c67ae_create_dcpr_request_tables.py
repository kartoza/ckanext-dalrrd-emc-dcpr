...
def upgrade():
    op.create_table(
        ...
        sa.Column("capture_start_date", types.DateTime),
        sa.Column("capture_end_date", types.DateTime),
        ...
        sa.Column("submission_date", types.DateTime),
        sa.Column(
            "nsif_review_date",
            types.DateTime,
        ),
        ...
        sa.Column("csi_moderation_date", types.DateTime),
    )
    ...
    op.create_table(
        ...
        sa.Column("proposed_dataset_title", types.UnicodeText),
        sa.Column("proposed_abstract", types.UnicodeText),
