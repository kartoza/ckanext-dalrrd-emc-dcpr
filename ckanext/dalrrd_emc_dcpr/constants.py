...
DATASET_MINIMAL_SET_OF_FIELDS = [
    ...
    "reference_date-0-date",
    "reference_date-0-date_type",
    "iso_topic_category",
    "owner_org",
    "private",
    "dataset_language",
...
DATASET_FULL_SET_OF_FIELDS = [
    ...
    "usage-0-datetime_to",
    "user_info-0-individual_name",
    "user_info-0-organisation_name",
    "user_info-0-position_name",
    "user_info-0-role",
    "user_contact_info-0-delivery_point",
    "user_contact_info-0-address_city",
    "user_contact_info-0-address_administrative_area",
    "user_contact_info-0-postal_code",
    "user_contact_info-0-electronic_mail_address",
    "user_contact_info-0-voice",
    "user_contact_info-0-facsimile",
    ...
    "metadata_record_format-0-amendment_number",
    "metadata_record_format-0-specification",
    "metadata_record_format-0-file_decompression_technique",
    "dataset_language",
    "metadata_language",
    "dataset_character_set",
    "metadata_character_set",
