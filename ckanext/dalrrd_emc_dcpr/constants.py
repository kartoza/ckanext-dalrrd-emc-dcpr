...
XML_DATASET_NAMING_MAPPING = {
    ...
    "ContactOrganisationName": "contact-0-organisation_name",
...
DATASET_SUBFIELDS_MAPPING = {
    ...
    "reference_date": "metadata_reference_date_and_stamp-0-reference",
    "reference_datetype": "metadata_reference_date_and_stamp-0-reference_date_type",
    "stamp_date": "metadata_reference_date_and_stamp-0-stamp",
    "stamp_datetype": "metadata_reference_date_and_stamp-0-stamp_date_type",
...
METADATA_STANDARD_NAME_AND_VERSION_FIELDS = {
    "metadata_name": "metadata_standard-0-name",
    "metadata_version": "metadata_standard-0-version",
}
...
class DCPRRequestRequiredFields(enum.Enum):
    ...
    METADATA_STANDARD_NAME = "SANS 1878-1:2011"
