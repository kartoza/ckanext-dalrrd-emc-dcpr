...
def test_create_package(name, private, org_role):
    ...
    data_dict = {
        ...
        "purpose": "purpose",
        "status": "completed",
        "contact-0-organisational_role": "resource_provider",
        "reference_date-0-reference_datetime_date": "2023-01-13",
        "reference_date-0-reference_datetime_time": "03:43",
        "metadata_record_format-0-name": "format name",
        "metadata_record_format-0-name": "1.0",
...
def test_update_package(name, private, org_role):
    ...
    data_dict = {
        ...
        "purpose": "purpose",
        "status": "completed",
        "metadata_point_of_contact-0-organisational_role": "resource_provider",
